...
- Spieler werden mit `assets/players/idle-right.png` und der Ball mit
  `assets/ball.png` gezeichnet, falls diese Dateien vorhanden sind - fehlen
  sie (noch), fällt der Renderer automatisch auf schlichte Kreise zurück,
  das Spiel bleibt also immer lauffähig. Wurf-/Fang-Animationsframes
  (`throw-1.png` … `throw-4.png`, `catch.png`) sind vorbereitet, aber noch
  nicht eingebunden.
