...
export class Renderer {
  constructor(canvas, players, onPlayerClick, assetsBasePath = "assets") {
    ...
    canvas.addEventListener("click", (e) => {
      ...
      // Skalierungsfaktor: interne Canvas-Auflösung (canvas.width/height) vs.
      // tatsächliche CSS-Darstellungsgröße (rect.width/height) können durch
      // die responsive Skalierung (max-width/max-height in cyberball.css)
      // voneinander abweichen - ohne diese Umrechnung landen Klicks auf der
      // rechten/unteren Seite außerhalb der erkannten Trefferzone.
